...
class Model(object):
    ...
    def __call__(self, inputs, training):
        ...
        resolution = 1
        inputs = conv2d(inputs=inputs, out_channal=64, kernel_size=7, strides=2, name='conv1')  # 缩小两倍
        resolution *= 2
...
if __name__ == '__main__':
    image = cv2.imread('../../round1_test_a/J01_2018.06.13 13_22_11.jpg')
    ...
    resnet = Model([[3, 256], [4, 512], [6, 1024], [3, 2048]])  # 第一个数是block个数，第二个数是输出通道数


### add batch_norm_updates
