...
class BatchPreprocessor(object):
    ...
    def __init__(self, dataset_file_path, num_classes, output_size=[512, 512], horizontal_flip=False, shuffle=False,
    ...
    def next_batch(self, batch_size):
        ...
        for i in range(len(paths)):
            ...
            if self.multi_scale is None:
                ...
                img = cv2.resize(img, (self.output_size[0], self.output_size[0]),interpolation=cv2.INTER_AREA)
